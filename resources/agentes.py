...
def agente_buscador(topico, data_de_hoje):
    buscador = Agent(
        ...
        tools=[google_search],
        instruction="""
        Você é um assistente de pesquisa. A sua tarefa é usar a ferramenta de busca da google (google_search) para recuperar as últimas notícias de lançamentos muito relevantes sobre o tópico abaixo.
...
def agente_planejador(topico, lancamentos_buscados):
    planejador = Agent(
        ...
        mais relevantes que poderíamos abordar em um post sobre cada um deles. Você também pode usar o (google_search)
...
if not topico:
  print("Você precisa digitar um tópico.")
  exit
else:
...
post_gerado = agente_revisor(topico, rascunho_de_post)
print("\nResultados do agente 4")
display(to_markdown(post_gerado))
print("---------------------------")
